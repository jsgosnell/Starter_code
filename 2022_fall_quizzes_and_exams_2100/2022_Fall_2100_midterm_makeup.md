---
title: "2022 Fall 2100 Midterm, makeup (31 points total)"
subtitle:  "Happy (late) Halloween"
author: "jsg"
date: "Last compiled on 10 November, 2022 17:26"
output:
  html_document:
    toc: true
    toc_float: true
...
3.  As one attempt at controlling the outbreak, a company has developed a drug
...
4. Given your answer to #3, what is your recommendation regarding the drug? In 
your answer, make sure to include the p-value and explain what it means.  (2 pts)

# #5


5. There is also concern that the new strain of lycanthropic virus is leading
...
6. Graph the data used in question 3 in an appropriate way that lets you visually
