...
---
Before doing this, review the **Introduction To Hypothesis Testing Via Binomial Tests
...
* Make you understand how to construct a null distribution
  ...
  + by using an appropriate distribution
*Calculate and compare p-values obtained using 
  + simulation (calculation won’t be required on test, but make sure you understand!)
...
4. I've produced a script in R that lets you test the Monty Hall idea (like in 
