...
10. Metabolic rates were measured before and after administering a drug. Data is
available at 
...
12. Endurance of the above animals was also measured. Data is available at
...
14. Using data from Australian athletes (http://www.statsci.org/data/oz/ais.html 
for details), determine if the average male training at the Australian Institute 
of Sport differs in from the average female training at the site in mercury
concentration (Hg). 

15. Laureysens et al. (2004) measured metal content in the wood of 13 poplar 
...
16. Data was collected on cholesterol levels following heart attacks.  Data
available at 
...
17. First plot how TotalSleep is explained by BrainWt (remember the issues with 
the data).  Use ggplot2 to plot the relationship.

18. Next color code each plot point by whether or not its a primate.  In order 
